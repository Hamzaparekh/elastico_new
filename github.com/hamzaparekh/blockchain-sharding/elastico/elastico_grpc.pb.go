...
const (
	SetupService_ReceiveIDProof_FullMethodName = "/elastico.SetupService/ReceiveIDProof"
)
...
type SetupServiceClient interface {
	ReceiveIDProof(ctx context.Context, in *IDProof, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *setupServiceClient) ReceiveIDProof(ctx context.Context, in *IDProof, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, SetupService_ReceiveIDProof_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SetupServiceServer interface {
	ReceiveIDProof(context.Context, *IDProof) (*emptypb.Empty, error)
...
func (UnimplementedSetupServiceServer) ReceiveIDProof(context.Context, *IDProof) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReceiveIDProof not implemented")
}
...
func _SetupService_ReceiveIDProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SetupService_ReceiveIDProof_FullMethodName,
	}
...
var SetupService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "elastico/elastico.proto",
}
